/*global window, console, RTCIceCandidate, RTCSessionDescription, webkitRTCPeerConnection*/
    ...
    if (msg.type === 'offer') {
      ...
      that.peerConnection.setRemoteDescription(new RTCSessionDescription(
        ...
        while (spec.remoteCandidates.length > 0) {
          console.log("Candidate :", spec.remoteCandidates[spec.remoteCandidates
            .length - 1]);
          that.peerConnection.addIceCandidate(spec.remoteCandidates.shift(),
            nullFunc, errorCallback);
