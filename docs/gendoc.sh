...
JSSDK_DIR=`cd ..; pwd`
JS_CODE="$JSSDK_DIR/src/sdk/conference/conference.js $JSSDK_DIR/src/sdk/base/events.js $JSSDK_DIR/src/sdk/base/stream.js $JSSDK_DIR/src/sdk/nuve/N.API.js $JSSDK_DIR/src/sdk/p2p/peer.js"
EXTRA_JSPATH=$@
